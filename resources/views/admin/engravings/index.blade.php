                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">إضافة نقش</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_add_category_form" method="post"
                                      action="{{ route('merchant.Engravings.store') }}" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href=""
                                                class="text-gray-800 text-hover-primary mb-1">{{toArabicNumber($record->name)}}</a>
                                        </div>
                                    </td>
                                    <td>
                                    @if ($record->status == 1 )
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            @if ($record->status == 1)
                                                <a href="{{ route('merchant.Sizes.destroy' , $record->id) }}" class="menu-link px-3"
                                               data-kt-users-table-filter="delete_row">حذف</a>
                                            @else
                                                <a href="{{ route('merchant.Sizes.destroy' , $record->id) }}" class="menu-link px-3"
                                                    data-kt-users-table-filter="delete_row">حذف</a>
                                                <a href="{{ route('admin.Engravings.update' , $record->id) }}" class="menu-link px-3"
                                                    data-kt-users-table-filter="delete_row">اجلعه متاحا</a>
                                            @endif
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
...
@section('script')
    ...
    <script>
        $(document).on('submit', '#kt_modal_add_category_form', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('merchant/engravings/store')}}",
                data: formData,
                processData: false,
                contentType: false,
