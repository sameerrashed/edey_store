                                ...
                                <form id="kt_modal_add_category" method="post"
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="d-block fw-bold fs-6 mb-5">Photo cover</label>
                                            <!--end::Label-->
                                            <!--begin::Image input-->
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                ...
                                                <label
                                                    ...
                                                    <input type="hidden" name="photo_cover"/>
                                                    <!--end::Inputs-->
                                                </label>
                                                <!--end::Label-->
                                                <!--begin::Cancel-->
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Ads</th>
                            <th class="min-w-125px">link url</th>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href=""
                                           class="text-gray-800 text-hover-primary mb-1">{{__("app.".$record->product_name)}}</a>
                                    </div>
                                </td>
                                <td>{{$record->link_url}}</td>
                                <td class="text-end">
