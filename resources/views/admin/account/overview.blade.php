...
@section("body")
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                ...
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="{{asset('img/' . auth()->user()->image)}}" alt="image"/>
                        <div
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#"
                                   class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{auth()->user()->first_name}} {{auth()->user()->last_name}}</a>
                                <a href="#">
                                ...
                                <a href="#" class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3"
                                   ...
                                   data-bs-target="#kt_modal_upgrade_plan">{{auth()->user()->role->name}}</a>
                            </div>
                            <!--end::Name-->
                            <!--begin::Info-->
                        ...
                        <div class="d-flex my-4">
                            ...
                            <a href="#" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal"
                               data-bs-target="#kt_modal_offer_a_deal">وظفني</a>
                            <!--begin::Menu-->
                            <div class="me-0">
                    ...
                    <div class="d-flex flex-wrap flex-stack">
                        ...
                        <div class="d-flex flex-column flex-grow-1 pe-8">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div
                                    ...
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">الأرباح</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                                <!--begin::Stat-->
                                <div
                                    ...
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">المشاريع</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                                <!--begin::Stat-->
                                <div
                                    ...
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">التقييم</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                            </div>
                        ...
                        <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                <span class="fw-bold fs-6 text-gray-400">إكمال الملف الشخصي</span>
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                       href="{{route('admin.Overview.index')}}">نظرة عامة على الحساب</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                       href="{{route('admin.Settings.index')}}">الإعدادات</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5"
                       href="../../demo1/dist/account/security.html">الأمان</a>
                </li>
            </ul>
            <!--begin::Navs-->
        </div>
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            <!--end::Card title-->
            <!--begin::Action-->
            <a href="{{route('admin.Settings.index')}}" class="btn btn-primary align-self-center">تعديل الملف
                الشخصي</a>
        </div>
        <!--begin::Card header-->
        <!--begin::Card body-->
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-4 fw-bold text-muted">الإسم كامل</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span
                        class="fw-bolder fs-6 text-gray-800">{{auth()->user()->first_name}} {{auth()->user()->last_name}}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-4 fw-bold text-muted">رقم التواصل
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    <span class="fw-bolder fs-6 text-gray-800 me-2"
                          dir="ltr">{{toArabicNumber(auth()->user()->phone)}}</span>
            ...
            @if(auth()->user()->role->name == "admin")
                <div class="row mb-7">
                    <label class="col-lg-4 fw-bold text-muted">الشركة</label>
                    <div class="col-lg-8 fv-row">
                        <span class="fw-bold text-gray-800 fs-6">Keenthemes</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-bold text-muted">موقع الشركة</label>
                    <div class="col-lg-8">
            ...
            @endif
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">المدينة
                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
            ...
            <div class="row mb-10">
                <label class="col-lg-4 fw-bold text-muted">السماح بالتغييرات</label>
                <div class="col-lg-8">
                    <span class="fw-bold fs-6 text-gray-800">نعم</span>
                </div>
            </div>
            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="fw-bold">
                        <h4 class="text-gray-900 fw-bolder">نحن بحاجة إلى انتباهكم!</h4>
                        <div class="fs-6 text-gray-700">تم رفض عملية الدفع. لبدء استخدام الأدوات، يرجى
                            <a class="fw-bolder" href="../../demo1/dist/account/billing.html">إضافة طريقة دفع</a>.
                        </div>
                    </div>
                </div>
            </div>
