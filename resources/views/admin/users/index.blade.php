            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                           class="form-control form-control-solid w-250px ps-14" placeholder="بحث عن مستخدم"/>
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">إضافة مستخدم</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div class="btn btn-icon btn-sm btn-active-icon-primary"
                            ...
                            <div class="col-md-6 col-xxl-4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                        ...
                                        <!--end::Avatar-->
                                        <!--begin::Name-->
                                        <a href="{{route('admin.Users.view',$record->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">
...
@section('script')
    <script>
        $(document).on('submit', '#kt_modal_add_category', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('admin/users/store')}}",
                data: formData,
                processData: false,
                contentType: false,
