            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <!--begin::Name-->
                        <a href="#"
                           class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{$record->first_name}} {{$record->last_name}}</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            <!--begin::Badge-->
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="تعديل بيانات المستخدم">
                        ...
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">
                                @if($record->last_login_at)
                                    <span class="d-block fw-bold fs-6 text-gray-800">
                                        {{ \Carbon\Carbon::parse($record->last_login_at)->translatedFormat('d F Y') }}
                                    </span>
                                    <span class="d-block fs-7 text-muted">
                                        {{ \Carbon\Carbon::parse($record->last_login_at)->translatedFormat('h:i A') }}
                                    </span>
                                @else
                ...
                <li class="nav-item ms-auto">
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <div class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">المدفوعات</div>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="#" class="menu-link px-5">إنشاء فاتورة</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="#" class="menu-link flex-stack px-5">إنشاء مدفوعات
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title">الاشتراك</span>
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-5">التطبيقات</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-5">الفواتير</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-5">البيانات</a>
                                </div>
                                <!--end::Menu item-->
                                    ...
                                    <div class="menu-content px-3">
                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                            ...
                                            <span class="form-check-label text-muted fs-6"
                                                  for="kt_user_menu_notifications">إشعارات</span>
                                        </label>
                                    </div>
                                </div>
                                <!--end::Menu item-->
                ...
                <div class="tab-pane fade show active" id="kt_user_view_overview_tab" role="tabpanel">
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-title flex-column">
                                <h2 class="mb-1">جدول المستخدمين</h2>
                                <div class="fs-6 fw-bold text-muted">اجتماعان قادمان</div>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                                ...
                                <div id="kt_schedule_day_0" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Creative
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Committee
                                                Review Approvals</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                ...
                                <div id="kt_schedule_day_1" class="tab-pane fade show active">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Sales
                                                Pitch Proposal</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                ...
                                <div id="kt_schedule_day_2" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Project
                                                Review &amp; Testing</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Lunch
                                                &amp; Learn Catch Up</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                ...
                                <div id="kt_schedule_day_3" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Development
                                ...
                                <div id="kt_schedule_day_5" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Weekly
                                                Team Stand-Up</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                ...
                                <div id="kt_schedule_day_6" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Dashboard
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-header mt-6">
                            <!--begin::Card title-->
                            <div class="card-title flex-column">
                                <h2 class="mb-1">مهام المستخدم</h2>
                                <div class="fs-6 fw-bold text-muted">إجمالي 25 مهمة متراكمة</div>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                                    ...
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                        <div class="fs-5 text-dark fw-bolder">تحديث الحالة</div>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Menu separator-->
                                    ...
                                    <form class="form px-7 py-5" data-kt-menu-id="kt-users-tasks-form">
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label fs-6 fw-bold">الحالة:</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button"
                                                    ...
                                                    data-kt-users-update-task-status="reset">إعادة ضبط
                                            </button>
                                            <button type="submit" class="btn btn-sm btn-primary"
                                                    data-kt-users-update-task-status="submit">
                                                <span class="indicator-label">يتقدم</span>
            ...
            <div class="modal-content">
                ...
                <form class="form" method="post" enctype="multipart/form-data" id="kt_modal_update_merchant_form">
                    ...
                    <div class="modal-header" id="kt_modal_update_user_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">تحديث بيانات المستخدم</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll"
                            ...
                            <div class="fw-boldest fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                                 ...
                                 aria-controls="kt_modal_update_user_user_info">معلومات المستخدم
                                <span class="ms-2 rotate-180">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                             height="24" viewBox="0 0 24 24" fill="none">
