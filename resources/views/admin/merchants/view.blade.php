            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <!--begin::Name-->
                        <a href="#"0
                            class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{$record->first_name}} {{$record->last_name}}
                        </a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            <!--begin::Badge-->
                            <div
                                class="badge badge-lg badge-light-primary d-inline">{{$record->role->name}}</div>
                            <!--begin::Badge-->
                        </div>
                        <!--end::Position-->
                        <!--begin::Info-->
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="تعديل بيانات التاجر">
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bolder mt-5">الإيميل</div>
                            ...
                            <div class="text-gray-600">
                                ...
                                <br/>{{$address_details->address_line2}}
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bolder mt-5">اللغة</div>
                            <div class="text-gray-600">الإنجليزية</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bolder mt-5">آخر تسجيل دخول</div>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0">
                    <div class="card-title">
                        <h3 class="fw-bolder m-0">الحسابات المتصلة</h3>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                <div class="card-body pt-2">
                    ...
                    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            <!--begin::Content-->
                            <div class="fw-bold">
                                <div class="fs-6 text-gray-700">بربط حسابك، فإنك توافق بموجب هذا على شروطنا
                                    <a href="#" class="me-1">سياسة الخصوصية</a>و
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="fs-5 text-dark text-hover-primary fw-bolder">جوجل</a>
                                    <div class="fs-6 fw-bold text-muted">خطط لسير عملك بشكل صحيح</div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fs-6 fw-bold text-muted">راقب مستودعاتك</div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <!--begin::Switch-->
                ...
                <div class="card-footer border-0 d-flex justify-content-center pt-0">
                    <button class="btn btn-sm btn-light-primary">حفظ التغييرات</button>
                </div>
                <!--end::Card footer-->
            </div>
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                ...
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                       href="#kt_user_view_overview_security">الأمان</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                       href="#kt_user_view_overview_events_and_logs_tab"> الفعاليات &amp; سجلات</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item ms-auto">
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <div class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">الحساب</div>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="#" class="menu-link text-danger px-5">حذف التاجر</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    <!--end::Menu-->
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-title flex-column">
                                <h2 class="mb-1">المتجر</h2>
                                <div class="fs-6 fw-bold text-muted">بيانات المتجر</div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" enctype="multipart/form-data" id="kt_modal_update_merchant_form">
                    @csrf
                    @if(isset($record))
                        @method("PATCH")
                    @endif

                    <input type="hidden" name="id" id="merchant_id" value="{{$record->id}}">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_update_user_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">تحديث بيانات التاجر</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll"
                            ...
                            <div class="fw-boldest fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                                 ...
                                 aria-controls="kt_modal_update_user_user_info">معلومات التاجر
                                <span class="ms-2 rotate-180">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                             height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div id="kt_modal_update_user_user_info" class="collapse show">
                                ...
                                <div class="fv-row mb-7">
                                    <select name="role_id" aria-label="Select a role"
                                        ...
                                        <option value="{{$record->role->id}}">{{$record->role->name}}</option>
                            ...
                            <div class="fw-boldest fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                                 ...
                                 aria-controls="kt_modal_update_user_address">تفاصيل العنوان
                                <span class="ms-2 rotate-180">
															<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <!--end::Svg Icon-->
                            ...
                            <div id="kt_modal_update_user_address" class="collapse show">
                                ...
                                <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select name="country" aria-label="إختر المدينة...." data-control="select2"
                                            data-placeholder="{{$address_details->country}}" class="form-select form-select-solid"
                                            data-dropdown-parent="#kt_modal_update_details">
                                        <option value="{{$address_details->country ?? '' }}">
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" class="btn btn-light me-3" data-kt-users-modal-action="cancel">تجاهل
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
...
{{--    <script>--}}
{{--        $(document).on('submit', '#kt_modal_update_merchant_form', function (e) {--}}
...
{{--            --}}{{--jQuery.ajax({--}}
{{--            --}}{{--    type: "POST",--}}
{{--            --}}{{--    url: "{{\Illuminate\Support\Facades\URL::to('admin/merchants/update')}}",--}}
{{--            --}}{{--    data: formData,--}}
{{--            --}}{{--    processData: false,--}}
{{--            --}}{{--    contentType: false,--}}
...
{{--            --}}{{--            });--}}
{{--            --}}{{--        } else {--}}
{{--            --}}{{--            $('#kt_modal_update_merchant_form')[0].reset();--}}
