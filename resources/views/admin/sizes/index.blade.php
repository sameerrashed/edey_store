            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                           class="form-control form-control-solid w-250px ps-14" placeholder="البحث عن مقاس"/>
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">إضافة مقاس</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">المقاس</th>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            @if ($record->status == 1)
                                                <a href="{{ route('admin.Sizes.destroy' , $record->id) }}" class="menu-link px-3"
                                               data-kt-users-table-filter="delete_row">حذف</a>
                                            @else
                                                <a href="{{ route('admin.Sizes.destroy' , $record->id) }}" class="menu-link px-3"
                                                    data-kt-users-table-filter="delete_row">حذف</a>
                                                <a href="{{ route('admin.Sizes.update' , $record->id) }}" class="menu-link px-3"
...
@section('script')
    ...
    <script>
        $(document).on('submit', '#kt_modal_add_category_form', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('admin/sizes/store')}}",
                data: formData,
                processData: false,
                contentType: false,
