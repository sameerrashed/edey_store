            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                        class="form-control form-control-solid w-250px ps-14" placeholder="بحث عن إحصائيات" />
                </div>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">إضافة إحصائيات</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_category" method="post" action="{{route('admin.Statistics.store')}}"
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_category_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="d-block fw-bold fs-6 mb-5">الأيقونة</label>
                                            <!--end::Label-->
                                            <!--begin::Image input-->
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="">
                                                <div class="symbol-label">
                                                    <img src="{{asset('img/' . $record->image)}}" alt="Emma Smith"
                                                        class="w-100" />
                                                </div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary mb-1">{{$record->title}}</a>
                                        </div>
                                    </td>
                                    <td class="text-end">
...
@section('script')
    ...
    <script>
        $(document).on('submit', '#kt_modal_add_category button[type="submit"]', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('/statistics/store')}}",
