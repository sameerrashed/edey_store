        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="cn_sign_layout">
                    ...
                    <form class="form_st1" method="post" action="{{route('signup.post')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn_prim btn_dt">إنشاء حساب</button>
                        <div class="note_sign"><p>أنت عضو فعلاً ؟ قم  <a href="{{route('website.login')}}">بتسجيل الدخول</a></p></div>
                    </form>
                </div>
            </div>
        </div>
