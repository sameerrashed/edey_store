                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">إضافة كود خصم</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                        ...
                                        @foreach($fields as $field)
                                            @switch($field["type"])
                                                ...
                                                @case("file")
                                                    ...
                                                    @break
                                                @case("date")
                                                    @include("admin.manage.partial.datepicker",["field" => $field])
                                                    @break
                                            @endswitch
                                        @endforeach
                                    </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">عدد مرات الخصم</th>
                            <th class="min-w-125px">تاريخ البداية</th>
                            <th class="min-w-125px">تاريخ النهاية</th>
                            <th class="min-w-125px">حالة الكوبون</th>
...
<style>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.calendar-icon', function () {
            $(this).closest('.date-picker-group').find('.datepicker')[0]._flatpickr.open();
        });
...
$(document).ready(function () {
    ...
    $(document).on('click', '.date-icon', function () {
        let input = $(this).closest('.date-input-group').find('.datepicker')[0];
    ...
    <script>
        $(document).on('submit', '#kt_modal_add_category', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('merchant/copons/store')}}",
                data: formData,
                processData: false,
                contentType: false,
