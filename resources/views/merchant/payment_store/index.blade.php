            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                        class="form-control form-control-solid w-250px ps-14" placeholder="البحث عن طريقة الدفع" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">إضافة طريقة دفع للمتجر</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_add_category_form" method="post"
                                    action="{{ route('merchant.Payment_Methods.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_category_scroll"
                                        ...
                                        <div class="mb-10 fv-row">
                                            <label class="required form-label">طرق الدفع الخاصة بالمتجر</label>
                                            <select name="payment_id[]" class="form-select form-select-solid lh-1 py-3"
                                                id="payment_select" data-placeholder="إختر طرق دفع المتجر"
                                                multiple="multiple">
                                                <option></option>
                                            ...
                                            <div class="text-muted fs-7 mb-7">أضف طريقة دفع للمتجر.</div>
                                        </div>
                                    </div>
                                    <!--end::Scroll-->-
                                    <!--begin::Actions-->
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            <!--begin::Table row-->
                            @foreach($payment_store_methods as $key => $record)
                                <tr>
                                    <td>
                                        {{($key + 1)}}
                                    </td>
                                    <td class="d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <a href=""
                                                class="text-gray-800 text-hover-primary mb-1">{{$record->paymentMethod->name}}</a>
                                        </div>
                                    </td>
...
@section('script')
    ...
    <script>
        $(document).on('submit', '#kt_modal_add_category_form', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('merchant/PaymentMethods/store')}}",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).ready(function () {
            ...
            $('#payment_select').select2({
                placeholder: 'إختر طرق دفع المتجر',
                allowClear: true,
                width: '100%',
