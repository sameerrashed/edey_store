            ...
            <form id="kt_account_profile_details_form" class="form" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body border-top p-9">
                    ...
                    @foreach($fields  as $field)
                        @switch($field["type"])
                            @case("text")
                                @include("admin.manage.settingPartial.input_text",["field" => $field])
                                @break
                            @case("file")
                                @include("admin.manage.settingPartial.input_file",["field" => $field])
                                @break
                        @endswitch
                    @endforeach
                </div>
...
@section('script')
    <script>
        $(document).on('submit', '#kt_account_profile_details_form', function (e) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "{{\Illuminate\Support\Facades\URL::to('admin/account/settings/update')}}",
                data: formData,
                processData: false,
                contentType: false,
