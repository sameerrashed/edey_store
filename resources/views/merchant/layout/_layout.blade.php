...
<body id="kt_body"
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <a href="../../demo1/dist/index.html">
                        <img alt="Logo" src="{{asset('img/logo.png')}}" class="h-25px logo" />
                    </a>
                    ...
                    <div id="kt_aside_toggle" class="btn btn-icon w-auto px-0 btn-active-color-primary aside-toggle"
                        ...
                        <span class="svg-icon svg-icon-1 rotate-180">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path opacity="0.5" d="M14.2657 11.4343L18.45 7.25C18.8642 6.83579
                                    18.8642 6.16421 18.45 5.75C18.0358 5.33579 17.3642 5.33579 16.95 5.75L11.4071
                                    11.2929C11.0166 11.6834 11.0166 12.3166 11.4071 12.7071L16.95 18.25C17.3642 18.6642
                                    18.0358 18.6642 18.45 18.25C18.8642 17.8358 18.8642 17.1642 18.45 16.75L14.2657
                                    12.5657C13.9533 12.2533 13.9533 11.7467 14.2657 11.4343Z" fill="currentColor" />
                                <path
                ...
                <div class="aside-menu flex-column-fluid">
                    <!--begin::Aside Menu-->
                    @include('merchant.partials.aside')
                    <!--end::Menu-->
                </div>
            </div>

            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="min-height: 100vh;
    display: flex;
    flex-direction: column;">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="flex: 1;">
                    <!--begin::Toolbar-->
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                    ...
                                    <!--begin::Display range-->
                                    <div class="text-gray-600 fw-bolder">نطاق تاريخ التحميل...</div>
                                    <!--end::Display range-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="fs-5 fw-bold mb-2">Task
                                        ...
                                        <a href="#" class="text-primary fw-bolder me-1">#45890</a>in “Ads Pro merchant
                                        Dashboard project:
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                            ...
                                            <div class="mb-3 mb-md-0 fw-bold">
                                                ...
                                                <div class="fs-6 text-gray-700 pe-7">Login into merchant Dashboard to
                                                    make sure
    ...
    <script>
        window.updateUrl = "{{ request()->is('merchant/merchants*') ? url('merchant/merchants/update') : url('merchant/users/update') }}";
    </script>
