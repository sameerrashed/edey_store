            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-5">
                    <form id="kt_ecommerce_settings_general_form" class="form"
                        action="{{ route('merchant.Products.update', $product->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method("PATCH")
                        <div class="mb-7">
                            ...
                            <div class="mt-1">
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    ...
                                    <div class="image-input-wrapper w-100px h-100px"
                                       style="background-image: url('{{ isset($product->avatar) && $product->avatar 
                                        ? asset('img/' . $product->avatar) 
                                        : asset('img/blank.svg') }}')"></div>
                                    <label
                                        ...
                                        <input type="hidden" name="avatar_remove" value="{{ $value->avatar }}"/>
                                    </label>
                                    <span
                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                        ...
                        <div class="mb-7">
                            ...
                            <div class="mt-1">
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                    <div class="image-input-wrapper w-100px h-100px"
                                        style="background-image: url({{ asset('img/blank.svg') }}"></div>
                                    <label
                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                        ...
                                        <div class="form-floating border rounded">
                                            ...
                                            <select id="color_select" class="form-select form-select-solid lh-1 py-3"
                                                ...
                                                @foreach ($colors as $record)
                                                    <option value="{{ $record->id }}"
                                                        @if($product->colors->contains($record->id)) selected @endif
                                    ...
                                    <div class="form-floating border rounded">
                                        ...
                                        <select id="size_select" class="form-select form-select-solid lh-1 py-3"
                                            ...
                                            @foreach ($sizes as $record)
                                                <option value="{{ $record->id }}"
                                                    @if($product->sizes->contains($record->id)) selected @endif
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                        ...
                                        <div class="form-floating border rounded">
                                            ...
                                            <select id="engraving_select" class="form-select form-select-solid lh-1 py-3"
                                                ...
                                                @foreach ($engravings as $record)
                                                    <option value="{{ $record->id }}"
                                                        @if($product->engravings->contains($record->id)) selected @endif
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid" name="count"
                                        value="{{ $value->count}}" required />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="form-check form-check-solid mb-5">
                                    <input name="CheckPrice" type="hidden" name="has_discount" value="0">
                                    <input name="CheckPrice" class="form-check-input" type="checkbox" id="has_discount" @if($value->price_after > 0)
                                        checked
                                        @else
                                        value="1"
                                    @endif >
                                ...
                                <!-- حقل السعر بعد الخصم -->
                                <div id="discount_price_box" style="{{ $value->price_after > 0 ? 'display:block;' : 'display:none;' }}">
