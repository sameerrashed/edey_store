        ...
        <div class="col-xl-12">
            ...
            <div class="post d-flex flex-column-fluid" id="kt_post">
                ...
                <div id="kt_content_container" class="container-xxl">
                    <form id="kt_ecommerce_add_product_form" action="{{ route('merchant.Products.update', $product->id) }}"
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-select mb-2" id="kt_ecommerce_add_product_store_template"
                                            ...
                                            @else
                                                ...
                                                <option value="2" selected>منتج متعدد</option>
                                            @endif
                                        </select>
                                    </div>
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="text" name="product_name" class="form-control mb-2"
                                                                placeholder="إسم المنتج" value="{{ $product->product_name }}"
                                                                required />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <textarea name="description" class="form-control mb-2" rows="6"
                                                                ...
                                                                required>@if ($product->description){{ $product->description }}@endif
                                                                                                                                                                                    </textarea>
                                                            <!--end::Editor-->
                                                            <!--begin::Description-->
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="number" name="price" class="form-control mb-2 price-input"
                                                                placeholder="سعر المنتج" value="{{ $product->price }}" dir="ltr"
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="number" name="price_after"
                                                                ...
                                                                placeholder="سعر المنتج بعد الخصم" dir="ltr"
                                                                style="text-align: left;" value="{{ $product->price_after }}" />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="number" name="cost_price"
                                                                ...
                                                                value="{{ $product->cost_price }}" dir="ltr"
                                                                style="text-align: left;" required />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="number" name="min_quantity"
                                                                class="form-control mb-2 price-input"
                                                                value="{{ $product->inventory->min_quantity }}" dir="ltr"
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="number" name="max_quantity"
                                                                class="form-control mb-2 price-input"
                                                                value="{{ $product->inventory->max_quantity }}" dir="ltr"
                                                                style="text-align: left;" />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="text" name="sku" class="form-control mb-2"
                                                                placeholder="رمز المنتج" value="{{ $product->sku }}" readonly />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <select name="stock_status" class="form-select mb-2"
                                                                ...
                                                                @else
                                                                    <option value="1">متوفر في المخزون
                                                                    </option>
                                                                    <option value="2" selected="selected">غير متوفر في المخزون</option>
                                                                @endif
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="number" name="quantity"
                                                                class="form-control mb-2 price-input"
                                                                value="{{ $product->inventory->quantity }}" dir="ltr"
                                                                style="text-align: left;" required />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                            ...
                                                            <select name="category[]"
                                                                ...
                                                                @foreach ($categories as $record)
                                                                    <option value="{{ $record->id }}"
                                                                        @if($product->categories->contains($record->id)) selected @endif
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <select name="brand_id" class="form-select mb-2" data-hide-search="true"
                                                                ...
                                                                @foreach ($brands as $record)
                                                                    <option value="{{ $record->id }}"
                                                                        @if($product->brand_id == $record->id) selected @endif>
                                                                        {{ $record->name}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            <select class="form-select form-select-solid lh-1 py-3"
                                                                ...
                                                                @foreach ($products as $record)
                                                                    @if($record->id != $product->id)
                                                                        <option value="{{ $record->id }}"
                                                                            @if($product->relateds->contains($record->id)) selected @endif
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body text-center pt-0">
                                                            ...
                                                            <div class="image-input image-input-empty image-input-outline mb-3"
                                                                data-kt-image-input="true" style="background-image: url('{{ isset($product->avatar) && $product->avatar
        ? asset('img/' . $product->avatar)
        : asset('img/blank.svg') }}')">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('merchant.Products.store') }}" id="kt_ecommerce_add_product_cancel"
                                            ...
                                            style=" background-color: #ffb822;border-color: #ffb822;color: #111;">تحويل كمسودة</a>
